                                    ...
                                    <div class="card-body card-dashboard">
                                        <table class="table display nowrap table-striped table-bordered scroll-horizontal" style="width: 100%">
                                            ...
                                            @isset($vendors)
                                                ...
                                                <tr>
                                                    <td> {{$vendor->name}} </td>
                                                    <td> <img src="{{$vendor->logo}}" width="100" height="50"></td>
                                                    <td>{{$vendor->mobile}}</td>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group"
                                                        ...
                                                        <a href="{{route('admin.vendors.status',$vendor->id)}}"
                                                           class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1">@if($vendor->active == 1) الغاء التفعيل  @else تفعيل @endif</a>
