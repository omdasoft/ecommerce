                                        ...
                                        <form class="form" action="{{route('admin.vendors.update',$vendor->id)}}" method="POST"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img src="{{$vendor -> logo}}" alt="صورة القسم"class="rounded-circle" height="150">
                                                </div>
                                            </div>
                                            <div class="form-group">
...
@section('script')
    ...
    <script>
        ...
        // <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBXlnJFHtwbVZlm5zGj5O_hDTPArM6vB6o&libraries=places">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDKZAuxH9xTzD2DLY2nKSPKrgRi2_y0ejs&libraries=places&callback=initAutocomplete&language=ar&region=SD
         async defer"></script>
@stop
