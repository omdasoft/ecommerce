...
{{--        // parameter when you first load the API. For example:--}}
    ...
    {{--    }--}}
    {{--</script>--}}
    {{--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBcl6GWpNUKmfWhNKcupNhYKV1x2B0vxJ0&libraries=places&callback=initAutocomplete&language=ar&region=EG--}}
    {{--     async defer"></script>--}}
@stop
